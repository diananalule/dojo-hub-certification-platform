  ...
  return (
    <div className="border-2 border-navy-950 rounded-2xl overflow-hidden max-w-2xl">
      <div className="bg-navy-950 text-white px-6 py-4 flex justify-between items-center">
        <div>
          <p className="text-[10px] font-mono uppercase text-crimson-400">Official Verifiable Credential</p>
      ...
      <div className="p-8 text-center space-y-3">
        <p className="text-[10px] uppercase text-navy-400 tracking-widest">This certifies that</p>
        ...
        <p className="text-[10px] uppercase text-navy-400 tracking-widest pt-2">Has fully achieved proficiency in</p>
        <h3 className="text-xl font-extrabold text-crimson-600">{credential.level.name} Level</h3>
        ...
        <div className="bg-navy-50 rounded-xl p-4 flex items-center justify-between text-left mt-4">
          <div className="min-w-0">
            <p className="text-[9px] uppercase text-navy-400 font-mono">Cryptographic Hash</p>
            <p className="text-[10px] font-mono text-navy-600 truncate">{credential.hash}</p>
